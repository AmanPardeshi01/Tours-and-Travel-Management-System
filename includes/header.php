                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                    <a class="dropdown-item text-black"
                      href="<?php echo APPURL; ?>/users/user.php?id=<?php echo $_SESSION['user_id']; ?>">Your Bookings</a>
                    <a class="dropdown-item text-black" href="#">Another action</a>
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item text-black" href="<?php echo APPURL; ?>/auth/logout.php">logout</a>
                  </div>
                </li>
