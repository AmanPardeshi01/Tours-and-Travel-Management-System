            ...
            <div class="controls">
                <?php foreach ($allCountries as $country): ?>
                    ...
                    <label for="banner<?php echo $country->id; ?>"><span class="progressbar"><span
                            ...
                            class="text"><?php echo $country->id; ?></span></label>
                <?php endforeach; ?>
            </div>
        </nav>
    </div>
                                ...
                                <div class="item">
                                    <div class="row">
                                        <div class="col-lg-4 col-sm-5">
                                            <div class="image">
                                                <img src="<?php echo COUNTRIESIMAGES; ?>/<?php echo $country->image; ?>"
                                                    alt="">
                                            </div>
                                        </div>
                                        <div class="col-lg-8 col-sm-7">
                                            <div class="right-content">
                                                ...
                                                <ul class="info">
                                                    <li><i class="fa fa-user"></i> <?php echo $country->population; ?> Mil
                                                        People</li>
                                                    <li><i class="fa fa-globe"></i> <?php echo $country->territory; ?> km2
                                                    </li>
